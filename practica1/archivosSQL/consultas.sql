...
SELECT idProyecto,project_title,DATEDIFF(end_actual_isodate,start_actual_isodate)as 
...
SELECT transactions.id,project_title,transactions.transaction_value from project,transactions 
WHERE 
    project_title LIKE "%RI-East Africa Public He%" 
AND 
    transactions.project_id=project.idProyecto 
